...
from examples.example_classes.tubemodel_testcase import optimisation_wingpropinfo
...
if __name__ == '__main__':
    # Start from
    optimisation_wingpropinfo.wing.empty_weight = 100  # to make T=D
    optimisation_wingpropinfo.wing.CL0 = 0.  # to make T=D
    optimisation_wingpropinfo.wing.CD0 = 0.03  # to make T=D
    
    optimisation_wingpropinfo.parameters.vinf = 160
    optimisation_wingpropinfo.parameters.air_density = 1.2087

    for iprop, _ in enumerate(optimisation_wingpropinfo.propeller):
        optimisation_wingpropinfo.propeller[iprop].rot_rate = 600
        optimisation_wingpropinfo.propeller[iprop].span *= 10
        optimisation_wingpropinfo.propeller[iprop].twist = np.array([46.77357992, 43.98483409, 41.42356386, 39.07255909, 36.90084483, 35.18368962,
    ...
    prob = om.Problem()
    prob.model = WingSlipstreamPropOptimisation(WingPropInfo=optimisation_wingpropinfo,
                                                objective=objective,
    ...
    all_plots(db_name=db_name,
              wingpropinfo=optimisation_wingpropinfo,
              savedir=savepath)
