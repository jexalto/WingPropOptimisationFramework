...
from src.integration.coupled_groups_optimisation import (
    WingSlipstreamPropOptimisation, 
    WingRethorstPropOptimisation,
    WingOptimisation
    )
...
if __name__ == '__main__':
    PROWIM_wingpropinfo.spanwise_discretisation_propeller = 19 # TODO: why doesn't this work for values smaller than 19?
    ...
    if False:
        ...
        #                                 includes=['*OPENAEROSTRUCT.AS_point_0.wing_perf.struct_funcs*'],
