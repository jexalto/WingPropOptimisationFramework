...
class WingModelTube(om.Group):
    ...
    def setup(self):
        ...
        surface = {
                    ...
                    "E": winginfo.youngsmodulus,  # [Pa] Young's modulus of the spar: divide by 2 for mimicing manoeuvre
                    "G": winginfo.G,  # [Pa] shear modulus of the spar
                    "yield": winginfo.yieldstress,  # [Pa] yield stress divided by 2.5 for limiting case
                    ...
                    "Wf_reserve": 0,
                    'tubemodel': wingpropinfo.tubemodelON
                    }
